...
* Concept Cardiology and Anotomic Pathology are supported for the create operation.
...
* Diagnostic Report cardiology Write API requires
...
Create a new diagnostic report for Cardiology concept.

<%= definition_table(:diagnostic_report_create_cardiology, :create, :r4) %>

### Example

#### Request

    POST https://fhir-ehr-latest.cerner.com/r4/d242a518-4074-4bd4-a3a6-adfe0c5c1c51/DiagnosticReport
...
Location: https://fhir-ehr-latest.cerner.com/r4/d242a518-4074-4bd4-a3a6-adfe0c5c1c51/DiagnosticReport/197466617
...
Create a new diagnostic report for Pathology concept.

<%= definition_table(:diagnostic_report_create_pathology, :create, :r4) %>
...
Etag: W/"1"
Last-Modified: Mon, 09 Oct 2023 17:29:02 GMT
Location: https://fhir-ehr-latest.cerner.com/r4/d242a518-4074-4bd4-a3a6-adfe0c5c1c51/DiagnosticReport/197466627
Referrer-Policy: strict-origin-when-cross-origin
